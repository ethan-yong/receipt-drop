...
Canonical API notes live in [`docs/api.md`](api.md); this file is a walkthrough of the control flow.
...
- [`docs/api.md`](api.md) — endpoint contract and shared helpers
- [`docs/architecture.md`](architecture.md) — end-to-end capture → sync → enrich flow
- [`docs/database.md`](database.md) — `llm_understanding`, `merchant_aliases`, RPCs
- [`docs/decisions.md`](decisions.md) — why LLM moved client-synchronous; alias cache

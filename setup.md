...
4. Add the redirect URL `com.receiptdrop.receiptdrop://login-callback` to the **Authorized redirect URIs** list in your Google Cloud Console OAuth client (alongside whatever web origin you use).

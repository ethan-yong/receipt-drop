...
void main() {
  ...
  test('reopening after a partial v10 migration does not crash', () async {
    // Simulate the crash state: the schema is fully at v10 (cleaned_ocr_text
    // already added) but user_version is still 9 because a previous run died
    // before drift bumped it. Reopening must re-run the v10 step without
    // hitting "duplicate column name".
    var db = await openDb();
